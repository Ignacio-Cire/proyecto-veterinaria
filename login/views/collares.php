...
<div class="container mt-5">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="javascript:agregarCarrito.js(0);" data-producto="collar1" class="btn btn-warning agregarCarrito">Agregar al carrito</a>
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../../img6.jpg" class="card-img-top" alt="Collar 2">
                <div class="card-body">
                    ...
                    <a href="javascript:agregarCarrito.js(0);" data-producto="collar2" class="btn btn-warning agregarCarrito">Agregar al carrito</a>
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../../img7.webp" class="card-img-top" alt="Collar 3">
                <div class="card-body">
                    ...
                    <a href="javascript:agregarCarrito.js(0);" data-producto="collar3" class="btn btn-warning agregarCarrito">Agregar al carrito</a>
